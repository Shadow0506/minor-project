...
This is a drop-in replacement for q_server.py that uses D3Q instead of basic DQN.
...
class D3QServer:
    ...
    def handle_state(self, parts):
        ...
        try:
            ...
            # Select action using D3Q-Network
...
def main():
    ...
    server = D3QServer(host='localhost', port=5555)
    server.start()
